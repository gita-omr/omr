...
OMR::DataType::createVectorType(TR::DataType elementType, TR::VectorLength length)
   ...
   TR::DataTypes type = static_cast<TR::DataTypes>(TR::FirstVectorType + (length - 1) * TR::NumVectorElementTypes + elementType - 1);
...
OMR::DataType::createMaskType(TR::DataType elementType, TR::VectorLength length)
   ...
   TR::DataTypes type = static_cast<TR::DataTypes>(TR::FirstMaskType + (length - 1) * TR::NumVectorElementTypes + elementType - 1);
