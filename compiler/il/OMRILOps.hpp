...
struct OpCodeProperties
   ...
   union
      ...
      OMR::VectorOperation operation;  /// order of the enum and in the properties table should match     
      };
   ...
   union
      ...
      OMR::VectorOperation swapChildrenOperation;
      };

   union
      {
      TR::ILOpCodes        reverseBranchOpCode;
      OMR::VectorOperation reverseBranchOperation;
      };
...
public:
   ...
   */
   ...
   TR::ILOpCodes getOpCodeForSwapChildren() const
      ...
      VectorOperation operation = _opCodeProperties[getTableIndex()].swapChildrenOperation;
   ...
   TR::ILOpCodes getOpCodeForReverseBranch() const
      ...
      VectorOperation operation = _opCodeProperties[getTableIndex()].reverseBranchOperation;
